...
> **ARXIV — `CLAUDE.md` ning 2026-08-17 gacha bo'lgan nusxasi. QAROR MANBAI EMAS.**
> Amaldagi shartnoma: repo ildizidagi `CLAUDE.md`.
>
> Bu nusxada tuzatilgan uch xato: rollar noto'g'ri nomlangan
> (`CLUB_ADMIN`/`CUSTOMER` kodda yo'q), pul JSON'da satr deb yozilgan
> (amalda butun son), `date-fns-tz` buyurilgan (loyihada o'rnatilmagan).
